This ZIP file is a package created for you at Nov 30 2012 21:48:22 GMT
by the FormMail Configuration wizard from www.tectite.com.

The package contains these files:
  scform.php          - your newly configured PHP FormMail script
  ...
  Contact-Form.htm    - an HTML form you designed
...
Here's what we recommend you do after uploading the files to your server:
   ...
   1. Test FormMail's alert messages using this URL:
        http://www.samuelsconsulting.com/scform.php?testalert=1

      You should receive an email to iphone@kqred.com.
   ...
   2. Test your sample forms, open these URLs:
        http://www.samuelsconsulting.com/sampleform-test.htm
      Submit the form.
      You should receive an email to this address:
        stew@samuelsconsulting.com
   ...
   4. These forms can be used immediately after uploading to your website:
        http://www.samuelsconsulting.com/sampleform.htm
        http://www.samuelsconsulting.com/Contact-Form.htm
...
freeware products by putting the following link on your website:
	Visit www.tectite.com for <a href="http://www.tectite.com/">php form</a>.
