 ...
 *  - was incorrectly adding <br> after </li>.
 ...
 *****************************************************************************/
	...
	//
 /* SES Entry */
$TARGET_URLS = array("http://www.samuelsconsulting.com/");// default; no URLs allowed Only email to this domain will be allowed
...
if (isset($SET_REAL_DOCUMENT_ROOT) && $SET_REAL_DOCUMENT_ROOT !== "")
	...
	//
/* SES Entry */
$TEMPLATEDIR = "http://www.samuelsconsulting.com/_php/fmtemplates";// directory for template files; empty string
	...
	//$TEMPLATEURL = "http://www.samuelsconsulting.com/_php/fmtemplates/errorl.html";
	...
	function ShowTemplate($s_name,$a_specs)
	{
		...
		if ($bIsUserError)
		{
			...
			if (!empty($s_link))
			{
				...
				{
						//
						// Look for a "<return_link/>" (or [return_link/]) tag and replace that.
