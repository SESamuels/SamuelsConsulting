...
$TARGET_EMAIL = array($EMAIL_NAME."@samuelsconsulting\.com$");

/* Help: http://www.tectite.com/fmdoc/def_alert.php */
$DEF_ALERT ="iphone@kqred.com";
...
$LOGDIR = "http://www.samuelsconsulting.com/_php/"; /* directory for log files; empty string to disallow log files */

/* Help: http://www.tectite.com/fmdoc/autorespondlog.php */
$AUTORESPONDLOG = "captest.txt"; /* file name in $LOGDIR for the auto responder log; empty string for no auto responder log */
...
$TEMPLATEURL = "http://www.samuelsconsulting.com/_php/fmtemplates"; /* default; no template URL */
...
$REQUIRE_CAPTCHA = "Please enter the image characters"; /* set to a message string if your forms */
